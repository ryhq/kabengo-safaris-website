...
export default function SafariDetailClient({ initialItin = null }: { initialItin?: Itin | null }) {
  ...
  const [itin, setItin] = useState<Itin | null>(initialItin);
  const [loading, setLoading] = useState(!initialItin);
