...
const FAQ_ITEMS = [
  ...
  { q: "Do I need vaccinations?", a: "Yellow fever vaccination is required for entry to Tanzania and Zanzibar. We also recommend being up to date on routine vaccinations and consulting your doctor about malaria prophylaxis. A travel clinic can provide personalized advice based on your itinerary." },
