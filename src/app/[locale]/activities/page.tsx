  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await apiClient.get(`/public/activities?${params}`, {
          ...
          {loading ? (
            ...
            <>
              <div className={`grid gap-6 lg:gap-8 ${
                activities.length === 1 ? "grid-cols-1 max-w-lg mx-auto" :
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        {activity.seasonAvailability && (
                          <p className="text-xs text-stone-400 mt-2 line-clamp-1">{activity.seasonAvailability}</p>
                        )}
